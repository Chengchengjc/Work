...
SPEED_GROUND = 6
IMG_GROUND = pygame.image.load('D:\\DP\\human-action-classification\\img\\ground.png')

SPEED_SKY = 1
IMG_SKY = pygame.image.load('D:\\DP\\human-action-classification\\img\\sky.png')

IMG_TREX = pygame.image.load("D:\\DP\\human-action-classification\\img\\tRex.png")
TIME_CHANGE_TREX = 6
Y_TREX = 105
X_TREX = 50
HIGH_MIN = 90
...
IMG_CATUS = pygame.image.load('D:\\DP\\human-action-classification\\img\\cactus.png')
Y_CATUS = 100

BIRD_IMG = pygame.image.load('D:\\DP\\human-action-classification\\img\\bird.png')
TIME_CHANGE_BIRD = 10
Y_BIRD_1 = 110
Y_BIRD_2 = 80
Y_BIRD_3 = 50
...
class Bird():
    def __init__(self, x, y, option = 0):
        ...
        self.timeChange = 0
        self.img = pygame.image.load("D:\\DP\\human-action-classification\\img\\bird.png")
...
# started and control the game
    while True:
        for event in pygame.event.get():
            ...
            if globals.q.get() =='upright':#站著就跳
                up = True
            else:
                up = False
                down = False  
        '''with open("D:\\DP\\human-action-classification\\result.txt", "r") as file:
            file_contents = file.read()
            if file_contents == "upright": #站著就跳
                up = True
            else:
                up = False
                down = False
